...
export SETUPFILE="setup.sh"
export AUTOSETUPFILE="autosetup.sh"
export AUTOSETUPCONFIG="/autosetup"
export INSTALLFILE="install.sh"
export FUNCTIONSFILE="functions.sh"
export GETOPTIONSFILE="get_options.sh"
export STANDARDCONFIG="standard.conf"
